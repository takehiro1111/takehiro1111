...
直近はアプリケーション開発も対応しております。  
今までの経験を活かし、ビジネス課題を主体的に見つけながら、より技術横断的にプロダクトの成長にコミットしたいと考えております。
...
- トライ & エラーでスピード感持って当事者として主体的に意思決定し、実行, 改善まで行い責任を持つこと。
...
# 自己PR
### 主体的な課題発見と解決
「こんな機能があったら良いな」「このコードはリファクタリングした方が良い」等、  
主体的に課題を見つけて対応することを心がけています。
また、ただ作業をするのではなく、主体的にコミュニケーションを取りながら良いプロダクトを作りたいという志向があります。
