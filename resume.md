...
今までのSRE,インフラ側の経験を活かし、ビジネス課題を主体的に見つけながら技術横断的にプロダクトの成長にコミットしたいと考えております。

# 働く上で大事にしたい価値観
- 技術だけでなく、プロダクト思考を持ってユーザーへの貢献や社会に対して良い影響を持つこと。
- 人と関わり、フラットな関係性でコミュニケーションを取りながら物事を前に進めること。
  - 事務的なやり取りだけでなく、仲間として感情的に繋がり、お互い良い刺激を与え合える関係性で仕事をしたい思想を持っています。
...
#### 社内ポータルシステムの機能開発,性能改善, インフラ運用改善
- GitLab Runnerで実行されるビルドの速度改善(25-30min->10-15min)
- テナント(部署)配下のユーザー一覧機能の速度改善(2s->0.8ms)
...
**SESの法人営業, インフラエンジニア（正社員）**  
2019年8月 ~ 2023年9月（4年2ヶ月）
